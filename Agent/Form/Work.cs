...
namespace Agent.Form
{
    public partial class Work : UserControl
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                panel3.Visible = true;
                button3.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (31).png");
                button3.Width = 313;
                button3.Left = 102;
                button6.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (31).png");
                button6.Width = 313;
                button6.Left = 102;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                panel3.Visible = true;
                button3.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (29).png");
                button3.Width = 377;
                button3.Left = 70;
                button6.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (29).png");
                button6.Width = 377;
                button6.Left = 70;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                panel3.Visible = true;
                button3.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (30).png");
                button3.Width = 298;
                button3.Left = 109;
                button6.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (30).png");
                button6.Width = 298;
                button6.Left = 109;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                panel3.Visible = true;
                button3.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (33).png");
                button3.Width = 217;
                button3.Left = 150;
                button6.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (33).png");
                button6.Width = 396;
                button6.Left = 60;
        ...
        public void Position_load()
        {
            sqlConnection.Open();
            DataSet dataSet = new DataSet();
            SqlDataAdapter command = new SqlDataAdapter($@"Select idposition, position.name as Должность ,harmhul as [Процент рисков],position.idwork from position inner join work on position.idwork=work.idwork where position.idwork={id}", sqlConnection);
            command.Fill(dataSet);
            ...
            else if (button3.Text == "Удалить работу")
            {
                ...
                if (id != 0)
                {
                    try
                    {
                        ...
                        {
                            //Удаление из БД данных о месте работы
                            sqlConnection.Open();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (button6.Text == "Добавить должность")
            {
                ...
                button8.Width = 174;
                button8.Left = 164;
                button8.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (31).png");
                panel8.Visible = true;
                panel3.Visible = false;
                panel2.Visible = false;
                panel1.Enabled = true;
            ...
            else if (button6.Text == "Вывод работ и должностей")
            {
                ...
                ExcelApp.Cells[2, 2] = "Процент рисков";
            ...
            else
            {
                if (id2 != 0)
                {
                    ...
                    dataGridView1.Enabled = false;
                    dataGridView2.Enabled = false;
                    button8.Image = new Bitmap(@"/Diplom/proga/Agent/Agent/Resources/pngwing.com (29).png");
                    panel8.Visible = true;
                    panel3.Visible = false;
                    panel2.Visible = false;
                    panel1.Enabled = true;
